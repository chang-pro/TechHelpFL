              ...
              >
                {isActive && (
                  ...
                  >
                    ...
                    <div className="absolute inset-[-4px] bg-orange-500/20 rounded-full blur-xl" />
                    <div className="absolute inset-[-8px] bg-orange-500/15 rounded-full blur-2xl" />
                    <div className="absolute inset-[-12px] bg-orange-500/5 rounded-full blur-3xl" />
